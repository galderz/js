...
forEach(numbers, function(number) { // Lambda
  sum += number;
});
console.log(sum);
// → 15
...
// The following code finds the percentage of a person’s known ancestors who
...
// Essentially, it is used to create a partially applied version of the function.
console.log(ancestry.filter(function(person) {
